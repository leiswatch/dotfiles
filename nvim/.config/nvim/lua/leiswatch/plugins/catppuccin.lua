		...
		require("catppuccin").setup({
			...
			custom_highlights = function(color)
				return {
					...
					CursorLineNr = { fg = color.subtext1, bg = color.none },
					LineNr = { fg = color.subtext1, bg = color.none },
					...
					TreesitterContextLineNumber = { fg = color.subtext1, bg = color.surface0 },
					...
					IncSearch = { fg = color.base, bg = color.maroon },
					CurSearch = { fg = color.base, bg = color.maroon },
					Search = { fg = color.none, bg = color.surface1 },
					MatchWord = { bg = color.maroon, fg = color.base, bold = false },
					MatchParen = { bg = color.maroon, fg = color.base, bold = false },
