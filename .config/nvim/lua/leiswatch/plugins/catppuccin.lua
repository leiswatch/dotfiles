		...
		require("catppuccin").setup({
			...
			custom_highlights = function(color)
				return {
					...
					IncSearch = { fg = color.base, bg = color.red },
					CurSearch = { fg = color.base, bg = color.red },
					Search = { fg = color.none, bg = color.surface1 },
					MatchWord = { bg = color.red, fg = color.base, bold = false },
					MatchParen = { bg = color.red, fg = color.base, bold = false },
